  ...
  switch (element.type) {
    case 'systems-table': {
      ...
      return {
        ...
        meaningWidth: st.meaningWidth || 400,
...
export function v2ElementToV1Update(
  ...
  if ('type' in v2Element) {
    if (v2Element.type === 'bidtable') {
      ...
      if (bt.meaningWidth !== undefined) updates.meaningWidth = bt.meaningWidth;
    ...
    if (anyUpdate.meaningWidth !== undefined) updates.meaningWidth = anyUpdate.meaningWidth;
