...
interface EmbeddedBoxElementProps {
  element: EmbeddedBoxElementType;
  onUpdate: (updates: Partial<EmbeddedBoxElementType>) => void;
}

export function EmbeddedBoxElement({
  element,
  onUpdate,
}: EmbeddedBoxElementProps) {
