...
import { SystemsTable, RowData } from './SystemsTable';
import { Button } from '../ui/button';
import { ResizableElement } from '../element-look-and-feel/ResizableElement';
import { SystemsTableFormatPanel } from './SystemsTableFormatPanel';
...
/**
 * SystemsTableWorkspace Component
 * 
 * A complete workspace for creating and managing multiple systems tables.
 * Tables can be freely positioned, dragged, and resized.
 * 
 * Usage:
 * ```tsx
 * import { SystemsTableWorkspace } from './components/systems-table';
 * 
 * function App() {
 *   return <SystemsTableWorkspace />;
 * }
 * ```
 */
export function SystemsTableWorkspace({ hideControls = false }: { hideControls?: boolean }) {
