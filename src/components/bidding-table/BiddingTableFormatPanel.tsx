...
interface BiddingTableFormatPanelProps {
  element: BiddingTableElement;
  onUpdate: (updates: Partial<BiddingTableElement>) => void;
  onClose: () => void;
}
...
export function BiddingTableFormatPanel({ element, onUpdate, onClose }: BiddingTableFormatPanelProps) {
