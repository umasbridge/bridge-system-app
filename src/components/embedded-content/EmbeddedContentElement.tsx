...
interface EmbeddedContentElementProps {
  element: EmbeddedContentElementType;
  onUpdate: (updates: Partial<EmbeddedContentElementType>) => void;
}

export function EmbeddedContentElement({
  element,
  onUpdate,
}: EmbeddedContentElementProps) {
  ...
  return (
    <>
      ...
      >
        <div className="w-full h-full flex flex-col items-start justify-start p-3 gap-2">
          {element.imageSrc && (
