...
export function Page({
  ...
  const sideMargin = parentSideMargin ?? page.leftMargin ?? 20; // inherit from parent or page setting
  ...
  const dynamicPageWidth = useMemo(() => {
    ...
    for (const el of page.elements) {
      if (el.type === 'bidtable') {
        ...
        const totalW = Math.max(tableEl.meaningWidth, bidW + 20) + wrapperPadding;
    ...
    return Math.max(widestElement + sideMargin * 2, MIN_PAGE_WIDTH);
  }, [page.elements, sideMargin]);
        ...
        return (
          ...
          >
            ...
            <BidTable
              ...
              initialMeaningWidth={tableEl.meaningWidth}
              gridlines={tableEl.gridlines}
              ...
              onMeaningWidthChange={(meaningWidth) => handleElementUpdate(element.id, { meaningWidth } as Partial<BidTableElement>)}
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{
            paddingTop: `${page.topMargin ?? 20}px`,
      ...
      {(() => {
        ...
        return (
          <div style={{ background: 'white', borderTop: '1px solid #e5e7eb', flexShrink: 0, padding: `12px ${sideMargin}px` }}>
