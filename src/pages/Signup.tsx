        ...
        <div className="space-y-6">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-20 h-20 mb-4">
              {/* Placeholder for logo - larger for signup (h-20 per Figma) */}
              <div className="w-20 h-20 bg-blue-600 rounded-full flex items-center justify-center text-white text-3xl font-bold">
                BS
              </div>
            </div>
            <h2 className="text-2xl font-medium text-neutral-900 mb-2">Create Account</h2>
            <p className="text-neutral-600">Start building your bridge system</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span className="text-neutral-700">Sign up with Apple</span>
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="confirm-password" className="block text-sm text-neutral-700 mb-2">
                Confirm Password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-neutral-400" aria-hidden="true" />
