...
export function BidTableRow({
  ...
  const actualMeaningWidth = Math.max(20, tableWidth - indentWidth - bidColumnWidth);
  ...
  const handleResizeStop = (_e: any, _direction: any, _ref: any, d: any) => {
    ...
    // Constrain so meaning column stays >= 20px (column_resize = redistribution only)
    const maxBidWidth = tableWidth - indentWidth - 20;
